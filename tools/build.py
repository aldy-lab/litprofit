...
def home():
    ...
    <section class="hero">
      ...
      <p class="plant-head">Plant <span class="sep">//</span> pull-down</p>
      <p class="plant-read"><span class="plant-t">+18</span><span class="plant-u">&deg;C</span></p>
      <svg class="plant-curve" viewBox="0 0 168 46" preserveAspectRatio="none">
        <line class="pc-grid" x1="0" y1="11.5" x2="168" y2="11.5"/>
        <line class="pc-grid" x1="0" y1="23" x2="168" y2="23"/>
        <line class="pc-grid" x1="0" y1="34.5" x2="168" y2="34.5"/>
        <path class="pc-trace" d="M0.0 3.0L3.0 5.4L6.0 7.6L9.0 9.7L12.0 11.6L15.0 13.5L18.0 15.2L21.0 16.8L24.0 18.4L27.0 19.8L30.0 21.2L33.0 22.5L36.0 23.7L39.0 24.8L42.0 25.9L45.0 26.9L48.0 27.9L51.0 28.8L54.0 29.6L57.0 30.4L60.0 31.1L63.0 31.8L66.0 32.5L69.0 33.1L72.0 33.7L75.0 34.2L78.0 34.7L81.0 35.2L84.0 35.7L87.0 36.1L90.0 36.5L93.0 36.9L96.0 37.3L99.0 37.6L102.0 37.9L105.0 38.2L108.0 38.5L111.0 38.8L114.0 39.0L117.0 39.3L120.0 39.5L123.0 39.7L126.0 39.9L129.0 40.1L132.0 40.2L135.0 40.4L138.0 40.6L141.0 40.7L144.0 40.8L147.0 41.0L150.0 41.1L153.0 41.2L156.0 41.3L159.0 41.4L162.0 41.5L165.0 41.6L168.0 41.7"/>
      </svg>
      <p class="plant-foot"><span class="plant-state">Cooling</span><span class="plant-set">Set &minus;25 &deg;C</span></p>
    </div>
